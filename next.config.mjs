    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://client.crisp.chat https://widget.crisp.chat https://js.stripe.com",
              ...
              "connect-src 'self' https://*.clerk.com https://*.stripe.com https://client.crisp.chat wss://client.relay.crisp.chat https://api.brevo.com",
